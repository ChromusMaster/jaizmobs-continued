...
public class FireFlyParticle extends SingleQuadParticle {
    ...
    FireFlyParticle(ClientLevel world, SpriteSet spriteProvider, double x, double y, double z, double velocityX, double velocityY, double velocityZ, RandomSource randomSource) {
    ...
    public static class FireFlyParticleFactory implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType simpleParticleType, ClientLevel clientWorld, double d, double e, double f, double g, double h, double i, RandomSource randomSource) {
            FireFlyParticle fireflyParticle = new FireFlyParticle(clientWorld, this.spriteProvider, d, e, f, 0.0, -0.8F, 0.0, randomSource) {
                @Override
                public Optional<ParticleLimit> getParticleLimit() {
                    return Optional.of(ParticleLimit.SPORE_BLOSSOM);
                }
            };
            fireflyParticle.lifetime = Mth.randomBetweenInclusive(randomSource, 500, 1000);
