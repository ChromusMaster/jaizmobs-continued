...
public final class Aeroblob extends EntityModel<JaizMobRenderState> {
	...
	public Aeroblob(ModelPart root) {
		super(root);
		this.head = root.getChild("aeroblob").getChild("body").getChild("head");
	...
	public static LayerDefinition getLayerDefinition() {
		...
		body.addOrReplaceChild("head", CubeListBuilder.create().texOffs(0, 17).addBox(-3.0F, -14.0F, 7.0F, 6.0F, 3.0F, 5.0F, new CubeDeformation(1.0F)), PartPose.offset(0.0F, 15.125F, 5.3333F));

		PartDefinition tentacles = body.addOrReplaceChild("tentacles", CubeListBuilder.create(), PartPose.offset(0.0F, 15.125F, 5.3333F));

		tentacles.addOrReplaceChild("1", CubeListBuilder.create().texOffs(14, 18).addBox(0.0F, 0.0F, -3.5F, 0.0F, 4.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offset(-4.0F, -10.0F, 2.5F));

		tentacles.addOrReplaceChild("2", CubeListBuilder.create().texOffs(0, 18).addBox(0.0F, 0.0F, -3.5F, 0.0F, 4.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offset(4.0F, -10.0F, 2.5F));

		tentacles.addOrReplaceChild("3", CubeListBuilder.create().texOffs(0, 37).addBox(0.0F, 0.0F, -3.0F, 0.0F, 4.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offset(2.5F, -11.0F, -4.0F));

		tentacles.addOrReplaceChild("4", CubeListBuilder.create().texOffs(17, 11).addBox(0.0F, 0.0F, -3.0F, 0.0F, 4.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offset(-2.5F, -11.0F, -4.0F));
