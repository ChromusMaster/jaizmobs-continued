...
public final class Cultivator extends EntityModel<JaizMobRenderState> {
	...
	public static LayerDefinition getLayerDefinition() {
		...
		PartDefinition top_jaw = head.addOrReplaceChild("top_jaw", CubeListBuilder.create().texOffs(66, 62).addBox(-5.0F, -3.0F, -10.0F, 10.0F, 4.0F, 10.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -2.0F, 0.0F));

		PartDefinition bottom_jaw = head.addOrReplaceChild("bottom_jaw", CubeListBuilder.create().texOffs(64, 0).addBox(-6.0F, -0.75F, -10.75F, 12.0F, 5.0F, 11.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -0.25F, -0.25F));
		...
		PartDefinition tiny_plant2_r1 = pod15.addOrReplaceChild("tiny_plant2_r1", CubeListBuilder.create().texOffs(0, 13).addBox(0.0F, -0.5F, -1.0F, 0.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -2.5F, 4.0F, 0.0F, -1.5708F, 0.0F));
		...
		PartDefinition tiny_plant4_r1 = pod16.addOrReplaceChild("tiny_plant4_r1", CubeListBuilder.create().texOffs(0, 10).addBox(0.0F, -1.5F, -1.0F, 0.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -4.0F, -4.0F, 0.0F, -1.5708F, 0.0F));

		PartDefinition tail_3 = tail_2.addOrReplaceChild("tail_3", CubeListBuilder.create().texOffs(0, 0).addBox(-2.0F, -2.0F, 0.0F, 4.0F, 4.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 9.0F));
		...
		PartDefinition small_plant15_r1 = pod14.addOrReplaceChild("small_plant15_r1", CubeListBuilder.create().texOffs(31, 67).addBox(-1.5F, -1.0F, 0.0F, 3.0F, 5.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -8.0F, 0.0F, 0.0F, -1.5708F, 0.0F));
		...
		PartDefinition small_plant13_r1 = pod13.addOrReplaceChild("small_plant13_r1", CubeListBuilder.create().texOffs(64, 97).addBox(-1.5F, -2.0F, 0.0F, 3.0F, 6.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -8.5F, 0.0F, 0.0F, -1.5708F, 0.0F));
		...
		PartDefinition plant2_r1 = pod1.addOrReplaceChild("plant2_r1", CubeListBuilder.create().texOffs(56, 92).addBox(-2.0F, -4.0F, 0.0F, 4.0F, 8.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -12.75F, 0.0F, 0.0F, -1.5708F, 0.0F));

		PartDefinition pod1_r1 = pod1.addOrReplaceChild("pod1_r1", CubeListBuilder.create().texOffs(72, 76).addBox(-2.0F, -5.0F, -2.0F, 4.0F, 10.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -4.0F, 0.0F, 0.0F, 0.0F, 0.0F));
		...
		PartDefinition plant4_r1 = pod2.addOrReplaceChild("plant4_r1", CubeListBuilder.create().texOffs(48, 92).addBox(-2.0F, -4.0F, 0.0F, 4.0F, 8.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -12.5F, 0.0F, 0.0F, -1.5708F, 0.0F));
		...
		PartDefinition plant6_r1 = pod3.addOrReplaceChild("plant6_r1", CubeListBuilder.create().texOffs(92, 28).addBox(-2.0F, -4.0F, 0.0F, 4.0F, 8.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -11.0F, 0.0F, 0.0F, -1.5708F, 0.0F));
		...
		PartDefinition plant9_r1 = pod4.addOrReplaceChild("plant9_r1", CubeListBuilder.create().texOffs(20, 20).addBox(-2.0F, -4.0F, 0.0F, 4.0F, 8.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -13.5F, 0.0F, 0.0F, -1.5708F, 0.0F));
		...
		PartDefinition plant8_r1 = pod5.addOrReplaceChild("plant8_r1", CubeListBuilder.create().texOffs(0, 67).addBox(-2.0F, -4.0F, 0.0F, 4.0F, 8.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -13.0F, 0.0F, 0.0F, -1.5708F, 0.0F));
		...
		PartDefinition plant11_r1 = pod6.addOrReplaceChild("plant11_r1", CubeListBuilder.create().texOffs(0, 0).addBox(-2.0F, -4.0F, 0.0F, 4.0F, 8.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -10.5F, 0.0F, 0.0F, -1.5708F, 0.0F));
		...
		PartDefinition small_plant4_r1 = pod7.addOrReplaceChild("small_plant4_r1", CubeListBuilder.create().texOffs(18, 96).addBox(-1.5F, -4.0F, 0.0F, 3.0F, 8.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -8.5F, 0.0F, 0.0F, -1.5708F, 0.0F));
		...
		PartDefinition small_plant2_r1 = pod8.addOrReplaceChild("small_plant2_r1", CubeListBuilder.create().texOffs(24, 96).addBox(-1.5F, -4.0F, 0.0F, 3.0F, 8.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -7.5F, 0.0F, 0.0F, -1.5708F, 0.0F));
		...
		PartDefinition small_plant6_r1 = pod9.addOrReplaceChild("small_plant6_r1", CubeListBuilder.create().texOffs(12, 96).addBox(-1.5F, -4.0F, 0.0F, 3.0F, 8.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -11.0F, 0.0F, 0.0F, -1.5708F, 0.0F));
		...
		PartDefinition small_plant7_r1 = pod10.addOrReplaceChild("small_plant7_r1", CubeListBuilder.create().texOffs(0, 96).addBox(-1.5F, -4.0F, 0.0F, 3.0F, 8.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -9.5F, 0.0F, 0.0F, -1.5708F, 0.0F));
		...
		PartDefinition small_plant9_r1 = pod11.addOrReplaceChild("small_plant9_r1", CubeListBuilder.create().texOffs(87, 95).addBox(-1.5F, -4.0F, 0.0F, 3.0F, 8.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -9.5F, 0.0F, 0.0F, -1.5708F, 0.0F));
		...
		PartDefinition small_plant11_r1 = pod12.addOrReplaceChild("small_plant11_r1", CubeListBuilder.create().texOffs(94, 49).addBox(-1.5F, -4.0F, 0.0F, 3.0F, 8.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -8.5F, 0.0F, 0.0F, -1.5708F, 0.0F));

		PartDefinition pod12_r1 = pod12.addOrReplaceChild("pod12_r1", CubeListBuilder.create().texOffs(12, 57).addBox(-1.5F, -4.5F, -1.5F, 3.0F, 5.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F));

		PartDefinition legs = cultivator.addOrReplaceChild("legs", CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition front_l = legs.addOrReplaceChild("front_l", CubeListBuilder.create().texOffs(52, 76).addBox(-1.5F, -1.5F, -2.5F, 5.0F, 11.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offset(9.5F, -9.5F, -8.5F));

		PartDefinition back_l = legs.addOrReplaceChild("back_l", CubeListBuilder.create().texOffs(32, 67).addBox(-1.5F, -1.5F, -2.5F, 5.0F, 11.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offset(9.5F, -9.5F, 8.5F));

		PartDefinition front_r = legs.addOrReplaceChild("front_r", CubeListBuilder.create().texOffs(0, 12).addBox(-3.5F, -1.5F, -2.5F, 5.0F, 11.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offset(-9.5F, -9.5F, -8.5F));

		PartDefinition back_r = legs.addOrReplaceChild("back_r", CubeListBuilder.create().texOffs(0, 41).addBox(-3.5F, -1.5F, -2.5F, 5.0F, 11.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offset(-9.5F, -9.5F, 8.5F));
