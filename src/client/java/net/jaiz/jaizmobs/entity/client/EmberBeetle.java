...
public final class EmberBeetle extends EntityModel<JaizMobRenderState> {
	...
	public EmberBeetle(ModelPart root) {
		super(root);
		this.head = root.getChild("emberbeetle").getChild("base").getChild("head");
	...
	public static LayerDefinition getLayerDefinition() {
		...
		base.addOrReplaceChild("head", CubeListBuilder.create().texOffs(0, 11).addBox(-1.5F, -1.0F, -2.0F, 3.0F, 2.0F, 2.0F, new CubeDeformation(0.0F))
		...
		shell.addOrReplaceChild("shell_l", CubeListBuilder.create().texOffs(8, 7).addBox(0.0F, -2.0F, 0.0F, 2.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));

		shell.addOrReplaceChild("shell_r", CubeListBuilder.create().texOffs(0, 5).addBox(-2.0F, -2.0F, 0.0F, 2.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));

		shell.addOrReplaceChild("wing_l", CubeListBuilder.create().texOffs(6, 0).addBox(0.0F, 0.0F, 0.0F, 2.0F, 0.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -1.0F, 0.0F));

		shell.addOrReplaceChild("wing_r", CubeListBuilder.create().texOffs(4, 5).addBox(-2.0F, 0.0F, 0.0F, 2.0F, 0.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -1.0F, 0.0F));
