...
public final class Enderwing extends EntityModel<JaizMobRenderState> {
	...
	public static LayerDefinition getLayerDefinition() {
		...
		PartDefinition tail_3 = tail_2.addOrReplaceChild("tail_3", CubeListBuilder.create().texOffs(89, 15).addBox(-1.0F, -1.0F, -11.0F, 2.0F, 2.0F, 11.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, -11.0F));
		...
		PartDefinition bottom_jaw = head.addOrReplaceChild("bottom_jaw", CubeListBuilder.create().texOffs(46, 80).addBox(-6.0F, 0.0F, 0.0F, 12.0F, 2.0F, 11.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 2.0F, -1.0F));

		PartDefinition wing_l = body.addOrReplaceChild("wing_l", CubeListBuilder.create().texOffs(53, 56).addBox(-11.0F, -1.0F, -8.0F, 11.0F, 3.0F, 21.0F, new CubeDeformation(0.0F))
				.texOffs(0, 25).addBox(-32.0F, -1.0F, -12.0F, 32.0F, 0.0F, 25.0F, new CubeDeformation(0.0F)), PartPose.offset(-8.0F, -2.0F, 0.0F));

		PartDefinition wing_r = body.addOrReplaceChild("wing_r", CubeListBuilder.create().texOffs(68, 29).addBox(0.0F, -1.0F, -8.0F, 11.0F, 3.0F, 21.0F, new CubeDeformation(0.0F))
