...
public final class FrostedTotemSpirit extends EntityModel<JaizMobRenderState> {
	...
	private final ModelPart frosted_totem_spirit;
	private final ModelPart head;

	public FrostedTotemSpirit(ModelPart root) {
		super(root);
		this.frosted_totem_spirit = root.getChild("frosted_totem_spirit");
		this.head = frosted_totem_spirit.getChild("base").getChild("head");
