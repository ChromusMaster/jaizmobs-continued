...
public final class FrostedTotemSpirit extends EntityModel<JaizMobRenderState> {
	private final KeyframeAnimation walkAnimation;
	private final KeyframeAnimation idleAnimation;
	private final KeyframeAnimation attackAnimation;
	private final ModelPart head;

	public FrostedTotemSpirit(ModelPart root) {
		super(root);
		this.head = root.getChild("frosted_totem_spirit").getChild("base").getChild("head");
	...
	public static LayerDefinition getLayerDefinition() {
		...
		PartDefinition totem_spirit = modelPartData.addOrReplaceChild("frosted_totem_spirit", CubeListBuilder.create(), PartPose.offset(0.0F, 24.0F, 0.0F));

		totem_spirit.addOrReplaceChild("left_leg", CubeListBuilder.create().texOffs(0, 32).addBox(0.0F, -1.0F, -2.0F, 4.0F, 8.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(2.0F, -7.0F, 0.0F));

		totem_spirit.addOrReplaceChild("right_leg", CubeListBuilder.create().texOffs(28, 28).addBox(-4.0F, -1.0F, -2.0F, 4.0F, 8.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(-2.0F, -7.0F, 0.0F));
		...
		mid.addOrReplaceChild("fist", CubeListBuilder.create().texOffs(24, 0).addBox(-2.0F, -20.0F, -2.0F, 4.0F, 3.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition doors = mid.addOrReplaceChild("doors", CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, 0.0F));

		doors.addOrReplaceChild("left_door", CubeListBuilder.create().texOffs(34, 40).addBox(0.0F, -23.0F, -4.0F, 4.0F, 8.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));

		doors.addOrReplaceChild("right_door", CubeListBuilder.create().texOffs(24, 40).addBox(-4.0F, -23.0F, -4.0F, 4.0F, 8.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));
		...
		head.addOrReplaceChild("horn_L_r1", CubeListBuilder.create().texOffs(0, 0).addBox(-1.0F, -37.0F, -5.0F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 26.0F, 0.0F, 0.0F, -1.5708F, 0.0F));
