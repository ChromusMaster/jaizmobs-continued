...
public final class PineGiant extends EntityModel<JaizMobRenderState> {
	...
	public static LayerDefinition getLayerDefinition() {
		...
		PartDefinition head = body.addOrReplaceChild("head", CubeListBuilder.create().texOffs(13, 80).addBox(-6.0F, -10.0F, -5.0F, 12.0F, 10.0F, 10.0F, new CubeDeformation(0.0F))
		...
		PartDefinition mushroom_r1 = mushrooms_r.addOrReplaceChild("mushroom_r1", CubeListBuilder.create().texOffs(8, 5).addBox(-1.0F, -1.5F, 1.0F, 4.0F, 5.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(9.0F, -50.5F, -2.5F, 0.0F, 0.0F, 0.0F));

		PartDefinition mushroom_r2 = mushrooms_r.addOrReplaceChild("mushroom_r2", CubeListBuilder.create().texOffs(34, 28).addBox(-2.0F, -2.5F, 0.0F, 4.0F, 5.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(10.0F, -37.5F, -1.5F, 0.0F, 3.1416F, 0.0F));

		PartDefinition mushroom_r3 = mushrooms_r.addOrReplaceChild("mushroom_r3", CubeListBuilder.create().texOffs(8, 0).addBox(-1.0F, 20.5F, -1.0F, 4.0F, 5.0F, 0.0F, new CubeDeformation(0.0F))
		...
		PartDefinition mushroom_r4 = mushrooms_r.addOrReplaceChild("mushroom_r4", CubeListBuilder.create().texOffs(54, 12).addBox(0.0F, 4.5F, 2.0F, 4.0F, 5.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(10.0F, -50.5F, 1.5F, 0.0F, -1.5708F, 0.0F));
		...
		PartDefinition mushroom_r5 = mushrooms_l.addOrReplaceChild("mushroom_r5", CubeListBuilder.create().texOffs(0, 0).addBox(-2.0F, -2.5F, 0.0F, 4.0F, 5.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-8.0F, -25.5F, -3.5F, 0.0F, -1.5708F, 0.0F));

		PartDefinition mushroom_r6 = mushrooms_l.addOrReplaceChild("mushroom_r6", CubeListBuilder.create().texOffs(0, 23).addBox(1.5F, 13.5F, -1.0F, 4.0F, 5.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-7.0F, -50.5F, 0.0F, 0.0F, 1.5708F, 0.0F));

		PartDefinition mushroom_r7 = mushrooms_l.addOrReplaceChild("mushroom_r7", CubeListBuilder.create().texOffs(8, 10).addBox(-2.0F, -2.5F, 0.0F, 4.0F, 5.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-8.0F, -27.5F, 3.5F, 0.0F, 1.5708F, 0.0F));

		PartDefinition mushroom_r8 = mushrooms_l.addOrReplaceChild("mushroom_r8", CubeListBuilder.create().texOffs(0, 28).addBox(-1.0F, 1.5F, -1.5F, 4.0F, 5.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-11.0F, -50.5F, 0.0F, 0.0F, 0.0F, 0.0F));

		PartDefinition leg_l = pine_giant.addOrReplaceChild("leg_l", CubeListBuilder.create().texOffs(54, 0).addBox(-2.0F, 0.0F, -2.5F, 5.0F, 7.0F, 5.0F, new CubeDeformation(0.0F))
				.texOffs(56, 23).addBox(-1.5F, 0.0F, -1.5F, 3.0F, 37.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offset(-3.0F, -37.0F, 0.0F));

		PartDefinition leg_r = pine_giant.addOrReplaceChild("leg_r", CubeListBuilder.create().texOffs(0, 60).addBox(-1.5F, 0.0F, -1.5F, 3.0F, 37.0F, 3.0F, new CubeDeformation(0.0F))
