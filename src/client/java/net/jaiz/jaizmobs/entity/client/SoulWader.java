...
public final class SoulWader extends EntityModel<JaizMobRenderState> {
	...
	public SoulWader(ModelPart root) {
		super(root);
		this.head = root.getChild("soul_wader").getChild("body").getChild("neck").getChild("head");
	...
	public static LayerDefinition getLayerDefinition() {
		...
		neck.addOrReplaceChild("head", CubeListBuilder.create().texOffs(63, 0).addBox(-5.0F, -4.5F, -10.6667F, 10.0F, 9.0F, 14.0F, new CubeDeformation(0.0F))
		...
		neck.addOrReplaceChild("mane", CubeListBuilder.create().texOffs(0, 76).addBox(-0.5F, -23.0F, -0.5F, 1.0F, 46.0F, 11.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -23.5F, 2.5F));

		neck.addOrReplaceChild("beard", CubeListBuilder.create().texOffs(24, 71).addBox(0.0F, -27.5F, -5.0F, 0.0F, 55.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -15.0F, -2.5F));
		...
		l_front.addOrReplaceChild("l_front2", CubeListBuilder.create().texOffs(88, 94).addBox(-1.5F, 0.0F, -1.5F, 3.0F, 47.0F, 3.0F, new CubeDeformation(0.0F))
		...
		l_back.addOrReplaceChild("l_back2", CubeListBuilder.create().texOffs(63, 104).addBox(-1.5F, 0.0F, -1.5F, 3.0F, 43.0F, 3.0F, new CubeDeformation(0.0F))
		...
		r_front.addOrReplaceChild("r_front2", CubeListBuilder.create().texOffs(88, 44).addBox(-1.5F, 0.0F, -1.5F, 3.0F, 47.0F, 3.0F, new CubeDeformation(0.0F))
		...
		r_back.addOrReplaceChild("r_back2", CubeListBuilder.create().texOffs(100, 71).addBox(-1.5F, 0.0F, -1.5F, 3.0F, 43.0F, 3.0F, new CubeDeformation(0.0F))
