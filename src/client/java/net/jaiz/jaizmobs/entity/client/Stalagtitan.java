...
public final class Stalagtitan extends EntityModel<JaizMobRenderState> {
	...
	public static LayerDefinition getLayerDefinition() {
		...
		PartDefinition arm_r = body.addOrReplaceChild("arm_r", CubeListBuilder.create().texOffs(24, 18).addBox(-3.0F, -2.0F, -2.0F, 3.0F, 27.0F, 3.0F, new CubeDeformation(0.0F))
		...
		PartDefinition shoulder_spine_r1 = arm_l.addOrReplaceChild("shoulder_spine_r1", CubeListBuilder.create().texOffs(0, 0).addBox(-3.5F, -4.25F, 1.0F, 4.0F, 6.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(5.0F, 0.0F, -1.0F, 0.0F, 0.0F, 0.8727F));
		...
		PartDefinition frill_top_r = head.addOrReplaceChild("frill_top_r", CubeListBuilder.create().texOffs(36, 45).addBox(-8.0F, -5.0F, 0.0F, 10.0F, 8.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offset(-2.0F, -9.0F, 0.0F));

		PartDefinition frill_top = head.addOrReplaceChild("frill_top", CubeListBuilder.create().texOffs(48, 36).addBox(-4.0F, -7.0F, 0.0F, 8.0F, 7.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -9.0F, -1.0F));

		PartDefinition frill_l = head.addOrReplaceChild("frill_l", CubeListBuilder.create().texOffs(48, 27).addBox(0.0F, -4.5F, 0.0F, 7.0F, 9.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offset(5.0F, -4.5F, -1.0F));

		PartDefinition frill_r = head.addOrReplaceChild("frill_r", CubeListBuilder.create().texOffs(48, 18).addBox(-7.0F, -4.5F, 0.0F, 7.0F, 9.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offset(-5.0F, -4.5F, -1.0F));

		PartDefinition frill_top_l = head.addOrReplaceChild("frill_top_l", CubeListBuilder.create().texOffs(45, 10).addBox(-2.0F, -5.0F, 0.0F, 10.0F, 8.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offset(2.0F, -9.0F, 0.0F));

		PartDefinition leg_l = stalagtitan.addOrReplaceChild("leg_l", CubeListBuilder.create().texOffs(12, 38).addBox(-1.5F, 0.0F, -1.5F, 3.0F, 27.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offset(2.5F, -27.0F, -0.5F));

		PartDefinition leg_r = stalagtitan.addOrReplaceChild("leg_r", CubeListBuilder.create().texOffs(0, 38).addBox(-1.5F, 0.0F, -2.0F, 3.0F, 27.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offset(-2.5F, -27.0F, 0.0F));
