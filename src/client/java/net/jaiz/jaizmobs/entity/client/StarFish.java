...
public final class StarFish extends EntityModel<JaizMobRenderState> {
	...
	public static LayerDefinition getLayerDefinition() {
		...
		PartDefinition fin_l_r1 = fin_l.addOrReplaceChild("fin_l_r1", CubeListBuilder.create().texOffs(8, 0).addBox(0.0F, -1.0F, 0.0F, 0.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.3927F, 0.0F));

		PartDefinition fin_r = body.addOrReplaceChild("fin_r", CubeListBuilder.create(), PartPose.offset(-1.0F, 0.0F, -1.0F));

		PartDefinition fin_r_r1 = fin_r.addOrReplaceChild("fin_r_r1", CubeListBuilder.create().texOffs(0, 0).addBox(0.0F, -1.0F, 0.0F, 0.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, -0.3927F, 0.0F));

		PartDefinition tail = body.addOrReplaceChild("tail", CubeListBuilder.create().texOffs(8, 3).addBox(0.0F, -2.0F, 0.0F, 0.0F, 4.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 2.0F));

		PartDefinition anal_fin = body.addOrReplaceChild("anal_fin", CubeListBuilder.create().texOffs(0, 2).addBox(0.0F, 0.0F, -2.0F, 0.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 1.0F, 0.0F));

		PartDefinition dorsal_fin = body.addOrReplaceChild("dorsal_fin", CubeListBuilder.create().texOffs(0, 5).addBox(0.0F, -3.0F, -2.0F, 0.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -1.0F, 0.0F));
