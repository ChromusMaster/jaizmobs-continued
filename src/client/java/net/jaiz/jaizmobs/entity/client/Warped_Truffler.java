...
public final class Warped_Truffler extends EntityModel<JaizMobRenderState> {
	...
	public static LayerDefinition getLayerDefinition() {
		...
		truffler.addOrReplaceChild("body", CubeListBuilder.create().texOffs(0, 0).addBox(-5.0F, -11.75F, -5.0F, 10.0F, 4.0F, 10.0F, new CubeDeformation(0.0F))
		...
		truffler.addOrReplaceChild("leg_r2", CubeListBuilder.create(), PartPose.offset(1.5F, 0.0F, 1.5F));
		...
		truffler.addOrReplaceChild("leg_l3", CubeListBuilder.create().texOffs(0, 4).addBox(-1.0F, 0.0F, -0.75F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(-1.5F, 0.0F, 1.25F));

		truffler.addOrReplaceChild("leg_r3", CubeListBuilder.create().texOffs(0, 0).addBox(-1.0F, 0.0F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(1.5F, 0.0F, 1.5F));
