...
public class JaizMod implements ModInitializer {
	...
	public void onInitialize() {
		...
		ModBlocks.registerModBlocks();
			...
			((FabricBlockEntityType) (Object) BlockEntityTypes.BRUSHABLE_BLOCK).addValidBlock(ModBlocks.FOSSIL_SOIL);
		...
		Registry.register(BuiltInRegistries.PARTICLE_TYPE, Identifier.fromNamespaceAndPath(JaizMod.MOD_ID, "stink_particle"), STINK_PARTICLE);
		Registry.register(BuiltInRegistries.PARTICLE_TYPE, Identifier.fromNamespaceAndPath(JaizMod.MOD_ID, "slime_drip_particle"), SLIME_DRIP_PARTICLE);
		Registry.register(BuiltInRegistries.PARTICLE_TYPE, Identifier.fromNamespaceAndPath(JaizMod.MOD_ID, "stink_item_particle"), STINK_ITEM_PARTICLE);
		Registry.register(BuiltInRegistries.PARTICLE_TYPE, Identifier.fromNamespaceAndPath(JaizMod.MOD_ID, "amethyst_sparkle_particle"), AMETHYST_SPARKLE_PARTICLE);
		Registry.register(BuiltInRegistries.PARTICLE_TYPE, Identifier.fromNamespaceAndPath(JaizMod.MOD_ID, "sprout_particle"), SPROUT_PARTICLE);
		Registry.register(BuiltInRegistries.PARTICLE_TYPE, Identifier.fromNamespaceAndPath(JaizMod.MOD_ID, "dry_leaf_particle"), DRY_LEAF_PARTICLE);
		Registry.register(BuiltInRegistries.PARTICLE_TYPE, Identifier.fromNamespaceAndPath(JaizMod.MOD_ID, "dead_leaf_particle"), DEAD_LEAF_PARTICLE);
		Registry.register(BuiltInRegistries.PARTICLE_TYPE, Identifier.fromNamespaceAndPath(JaizMod.MOD_ID, "firefly_particle"), FIREFLY_PARTICLE);
		Registry.register(BuiltInRegistries.PARTICLE_TYPE, Identifier.fromNamespaceAndPath(JaizMod.MOD_ID, "blooming_ivy_particle"), BLOOMING_IVY_PARTICLE);
		Registry.register(BuiltInRegistries.PARTICLE_TYPE, Identifier.fromNamespaceAndPath(JaizMod.MOD_ID, "snow_particle"), SNOW_PARTICLE);
