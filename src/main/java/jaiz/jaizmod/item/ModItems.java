...
public class ModItems {
    ...
    public static BlockItem registerBlockItem(String name, Block block) {
        return registerItem(name, settings -> new BlockItem(block, settings), new Item.Properties().useBlockDescriptionPrefix());
    }


    public static <I extends Item> I registerItem(String name, Function<Item.Properties, I> factory, Item.Properties settings) {
        ResourceKey<Item> key = ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(JaizMod.MOD_ID, name));
    ...
    public static final Item SEQUOIA_CONE = registerItem("sequoia_cone", DescribedItem::new, new Item.Properties().food(ModFoodComponents.SEQUOIA_CONE));
    */
    ...
    public static final Item PETRIFIED_ARMOR_TRIM_SMITHING_TEMPLATE = registerItem(
            "petrified_armor_trim_smithing_template", SmithingTemplateItem::createArmorTrimTemplate, new Item.Properties().rarity(Rarity.UNCOMMON)
    );
    ...
    public static final Item GLOWING_SPYGLASS = registerItem("glowing_spyglass", GlowingSpyGlassItem::new, new Item.Properties().stacksTo(1).durability(64));
    ...
    public static final Item WATER_TORCH = registerItem(
            "water_torch",
            settings -> new StandingAndWallBlockItem(ModBlocks.WATER_TORCH, ModBlocks.WALL_WATER_TORCH, Direction.DOWN, settings)
    );

    public static final Item GUANO = registerItem("guano", GuanoItem:: new, new Item.Properties());
    public static final Item GLOW_BALL = registerItem("glowball", GlowBallItem::new, new Item.Properties());

    public static final Item SNAIL_SPAWN_EGG = registerItem("snail_spawn_egg", SpawnEggItem::new, new Item.Properties().spawnEgg(ModEntities.SNAIL));
    public static final Item CATERPILLAR_SPAWN_EGG = registerItem("caterpillar_spawn_egg", SpawnEggItem::new, new Item.Properties().spawnEgg(ModEntities.CATERPILLAR));
    public static final Item BUTTERFLY_SPAWN_EGG = registerItem("butterfly_spawn_egg", SpawnEggItem::new, new Item.Properties().spawnEgg(ModEntities.BUTTERFLY));
    public static final Item FIREFLY_SWARM_SPAWN_EGG = registerItem("firefly_swarm_spawn_egg", SpawnEggItem::new, new Item.Properties().spawnEgg(ModEntities.FIRE_FLY_SWARM));
    public static final Item DRAGONFLY_SPAWN_EGG = registerItem("dragonfly_spawn_egg", SpawnEggItem::new, new Item.Properties().spawnEgg(ModEntities.DRAGONFLY));

    public static final Item MIMIC_POT = registerItem("mimic_pot", SpawnEggItem::new, new Item.Properties().spawnEgg(ModEntities.MASON_MOUTH).stacksTo(1));

    public static final Item BANDIT_SPAWN_EGG = registerItem("bandit_spawn_egg", SpawnEggItem::new, new Item.Properties().spawnEgg(ModEntities.BANDIT));

    public static final Item SILK = registerItem("silk", Item::new, new Item.Properties());
    public static final Item BATTERED_AXE_REMNANT = registerItem("battered_axe_remnant", Item::new, new Item.Properties());

    public static final Item ANCIENT_HORN = registerItem(
            "ancient_horn", AncientHornItem::new, new Item.Properties().rarity(Rarity.UNCOMMON).stacksTo(1).durability(64)
    );
    public static final Item AIR_HORN = registerItem(
            "air_horn", AirHornItem::new, new Item.Properties().rarity(Rarity.UNCOMMON).stacksTo(1).durability(64)
    );
    ...
    public static final Item SNIFFER_MEAT = registerItem("sniffer_meat", DescribedItem::new, new Item.Properties().food(ModFoodComponents.SNIFFER_MEAT));
    public static final Item COOKED_SNIFFER_MEAT = registerItem("cooked_sniffer_meat", DescribedItem::new, new Item.Properties().food(ModFoodComponents.COOKED_SNIFFER_MEAT));

    public static final Item DYNAMITE = registerItem("dynamite", DynamiteItem::new, new Item.Properties());

    public static final Item RARE_SPICES = registerItem("rare_spices", Item::new, new Item.Properties().food(ModFoodComponents.RARE_SPICES, ConsumableComponents.RARE_SPICES));
    public static final Item GOURMET_MEAL = registerItem("gourmet_meal", Item::new, new Item.Properties().food(ModFoodComponents.GOURMET_MEAL, ConsumableComponents.GOURMET_MEAL).stacksTo(16));
    public static final Item OBSIDIAN_SHARD = registerItem("obsidian_shard", Item::new, new Item.Properties());
    public static final Item SHARP_OBSIDIAN_SHARD = registerItem("sharp_obsidian_shard", Item::new, new Item.Properties());
    public static final Item WEDGE_OBSIDIAN_SHARD = registerItem("wedge_obsidian_shard", Item::new, new Item.Properties());

    public static final Item UNFIRED_TEA_CUP = registerItem("unfired_tea_cup", Item::new, new Item.Properties().stacksTo(1));
    public static final Item TEA_CUP = registerItem("tea_cup", Item::new, new Item.Properties().stacksTo(1));
    public static final Item CHORUS_FRUIT_TEA = registerItem("chorus_fruit_tea",  ChorusTeaItem::new, new Item.Properties().food(ModFoodComponents.CHORUS_TEA, ConsumableComponents.CHORUS_TEA).stacksTo(1));
    public static final Item NOVEL_TEA = registerItem("novel_tea",  NovelTeaItem::new, new Item.Properties().food(ModFoodComponents.TEA, ConsumableComponents.TEA).stacksTo(1));
    public static final Item FLOWER_TEA = registerItem("flower_tea",  TeaItem::new, new Item.Properties().food(ModFoodComponents.TEA, ConsumableComponents.TEA).stacksTo(1));
    public static final Item GLOW_BERRY_TEA = registerItem("glow_berry_tea",  TeaItem::new, new Item.Properties().food(ModFoodComponents.GLOW_BERRY_TEA, ConsumableComponents.GLOW_BERRY_TEA).stacksTo(1));
    public static final Item GUNPOWDER_GREEN_TEA = registerItem("gunpowder_green_tea",  GunPowderTeaItem::new, new Item.Properties().food(ModFoodComponents.TEA, ConsumableComponents.TEA).stacksTo(1));
    public static final Item HERBAL_TEA = registerItem("herbal_tea",  TeaItem::new, new Item.Properties().food(ModFoodComponents.TEA, ConsumableComponents.TEA).stacksTo(1));
    public static final Item KOMBUCHA_TEA = registerItem("kombucha_tea",  TeaItem::new, new Item.Properties().food(ModFoodComponents.TEA, ConsumableComponents.TEA).stacksTo(1));
    public static final Item NETHER_FUNGUS_TEA = registerItem("nether_fungus_tea",  TeaItem::new, new Item.Properties().food(ModFoodComponents.NETHER_FUNGAL_TEA, ConsumableComponents.NETHER_FUNGAL_TEA).stacksTo(1));
    public static final Item WARPED_NETHER_FUNGUS_TEA = registerItem("warped_nether_fungus_tea",  TeaItem::new, new Item.Properties().food(ModFoodComponents.NETHER_FUNGAL_TEA, ConsumableComponents.NETHER_FUNGAL_TEA).stacksTo(1));
    public static final Item PITCHER_PLANT_TEA = registerItem("pitcher_plant_tea",  TeaItem::new, new Item.Properties().food(ModFoodComponents.PITCHER_PLANT_TEA, ConsumableComponents.PITCHER_PLANT_TEA).stacksTo(1));
    public static final Item PUMPKIN_SPICE_TEA = registerItem("pumpkin_spice_tea",  TeaItem::new, new Item.Properties().food(ModFoodComponents.TEA, ConsumableComponents.TEA).stacksTo(1));
    public static final Item SPORE_BLOSSOM_TEA = registerItem("spore_blossom_tea",  TeaItem::new, new Item.Properties().food(ModFoodComponents.SPORE_BLOSSOM_TEA, ConsumableComponents.SPORE_BLOSSOM_TEA).stacksTo(1));
    public static final Item TORCH_FLOWER_TEA = registerItem("torch_flower_tea",  TeaItem::new, new Item.Properties().food(ModFoodComponents.TORCH_FLOWER_TEA, ConsumableComponents.TORCH_FLOWER_TEA).stacksTo(1));
    public static final Item WITHER_ROSE_TEA = registerItem("wither_rose_tea",  WitherTeaItem::new, new Item.Properties().food(ModFoodComponents.WITHER_ROSE_TEA, ConsumableComponents.WITHER_ROSE_TEA).stacksTo(1));
    ...
    public static final Item OBSIDIAN_SWORD = registerItem(
            "obsidian_sword",
            settings -> new Item(settings.sword(ModToolMaterial.OBSIDIAN_SWORD, 2, -2.4f)));
    public static final Item SHARP_OBSIDIAN_SWORD = registerItem(
            "sharp_obsidian_sword",
            settings -> new Item(settings.sword(ModToolMaterial.SHARP_OBSIDIAN_SWORD, 2, -2.0f)));
    public static final Item WEDGE_OBSIDIAN_SWORD = registerItem(
            "wedge_obsidian_sword",
            settings -> new Item(settings.sword(ModToolMaterial.WEDGE_OBSIDIAN_SWORD, 1, -2.8f)));
    public static final Item WEDGE_REGULAR_OBSIDIAN_SWORD = registerItem(
            "wedge_regular_obsidian_sword",
            settings -> new Item(settings.sword(ModToolMaterial.WEDGE_REGULAR_OBSIDIAN_SWORD, 2, -2.8f)));
    public static final Item SHARP_REGULAR_OBSIDIAN_SWORD = registerItem(
            "sharp_regular_obsidian_sword",
            settings -> new Item(settings.sword(ModToolMaterial.SHARP_REGULAR_OBSIDIAN_SWORD, 3, -2.0f)));
    public static final Item SHARP_WEDGE_OBSIDIAN_SWORD = registerItem(
            "sharp_wedge_obsidian_sword",
            settings -> new Item(settings.sword(ModToolMaterial.SHARP_WEDGE_OBSIDIAN_SWORD, 3, -3.2f)));
    public static final Item OBSIDIAN_DAGGER = registerItem(
            "obsidian_dagger",
            settings -> new Item(settings.sword(ModToolMaterial.OBSIDIAN_DAGGER, 2, -2.4f)));
    public static final Item SHARP_OBSIDIAN_DAGGER = registerItem(
            "sharp_obsidian_dagger",
            settings -> new Item(settings.sword(ModToolMaterial.SHARP_OBSIDIAN_DAGGER, 2, -2.0f)));
    public static final Item WEDGE_OBSIDIAN_DAGGER = registerItem(
            "wedge_obsidian_dagger",
            settings -> new Item(settings.sword(ModToolMaterial.WEDGE_OBSIDIAN_DAGGER, 3, -2.8f)));
    ...
    public static final Item ORIGAMI_HAIRBALL_MUSIC_DISC = registerItem("origami_hairball_music_disc", Item::new, new Item.Properties().jukeboxPlayable(ModSounds.of("origami_hairball")).rarity(Rarity.RARE).stacksTo(1));

    public static final Item ROTTEN_SIGN = registerItem("rotten_sign", settings -> new SignItem(ModBlocks.STANDING_ROTTEN_SIGN, ModBlocks.WALL_ROTTEN_SIGN, settings), new Item.Properties().stacksTo(16).useBlockDescriptionPrefix());
    public static final Item ROTTEN_HANGING_SIGN = registerItem("rotten_hanging_sign", settings -> new HangingSignItem(ModBlocks.HANGING_ROTTEN_SIGN, ModBlocks.WALL_HANGING_ROTTEN_SIGN, settings), new Item.Properties().stacksTo(16).useBlockDescriptionPrefix());
    public static final Item MAHOGANY_SIGN = registerItem("mahogany_sign", settings -> new SignItem(ModBlocks.STANDING_MAHOGANY_SIGN, ModBlocks.WALL_MAHOGANY_SIGN, settings), new Item.Properties().stacksTo(16).useBlockDescriptionPrefix());
    public static final Item MAHOGANY_HANGING_SIGN = registerItem("mahogany_hanging_sign", settings -> new HangingSignItem(ModBlocks.HANGING_MAHOGANY_SIGN, ModBlocks.WALL_HANGING_MAHOGANY_SIGN, settings), new Item.Properties().stacksTo(16).useBlockDescriptionPrefix());
    public static final Item DESERT_OAK_SIGN = registerItem("desert_oak_sign", settings -> new SignItem(ModBlocks.STANDING_DESERT_OAK_SIGN, ModBlocks.WALL_DESERT_OAK_SIGN, settings), new Item.Properties().stacksTo(16).useBlockDescriptionPrefix());
    public static final Item DESERT_OAK_HANGING_SIGN = registerItem("desert_oak_hanging_sign", settings -> new HangingSignItem(ModBlocks.HANGING_DESERT_OAK_SIGN, ModBlocks.WALL_HANGING_DESERT_OAK_SIGN, settings), new Item.Properties().stacksTo(16).useBlockDescriptionPrefix());
    ...
    public static BlockItem registerCocoonBlockItem(String name, Block block) {
        return registerItem(name, settings -> new BlockItem(block, settings), new Item.Properties().useBlockDescriptionPrefix().food(ModFoodComponents.COCOON, ConsumableComponents.COCOON).stacksTo(1));
    }
