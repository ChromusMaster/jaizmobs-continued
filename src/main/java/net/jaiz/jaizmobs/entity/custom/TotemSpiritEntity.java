...
public class TotemSpiritEntity extends Monster implements AttackingMob {

    private static final EntityDataAccessor<Boolean> ATTACKING =
            SynchedEntityData.defineId(TotemSpiritEntity.class, EntityDataSerializers.BOOLEAN);
    ...
    public TotemSpiritEntity(EntityType<? extends Monster> entityType, Level world) {
    ...
    protected void initCustomGoals() {
        ...
        this.goalSelector.addGoal(2, new TotemSpiritAttackGoal(this, 1d, false));
    ...
    public static AttributeSupplier.Builder createTotemSpiritAttributes() {
